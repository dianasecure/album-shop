...
export default function EditOneAlbumPage() {
  const { editOneAlbum, selectedAlbum } = useAlbums();
  const [album, setAlbum] = useState(selectedAlbum || {
    title: "", artist: "", genre: "", year: "", price: "", format: "CD", image: "", songs: []
  });
  ...
  return (
    <div className="p-6 bg-orange-50">
      ...
      <h1 className="text-2xl font-bold text-stone-950">Edit CD/Vinyl</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="bg-stone-800 text-white px-4 py-2 rounded">Edit Album</button>
      </form>
    </div> 
  );
}
